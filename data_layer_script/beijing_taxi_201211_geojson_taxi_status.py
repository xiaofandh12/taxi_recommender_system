...
proc_output_dir = '/home/donghao/ITS_project/taxi_finder/data_geojson_taxi_status/taxi_status/'
...
class Geojson:
	...
	def cuid_end_callback(self,cuid):
		...
		self.write_to_file(proc_output_dir  + prefix + '_' + str(CUID_count) + '_taxi_status'+ '.json')
...
for tbname in tbnames:
	...
	for CUID_count in range(1,1001):
		...
		print proc_output_dir + prefix +'_' + str(CUID_count) + '_taxi_status' + '.json' , 'completed'
