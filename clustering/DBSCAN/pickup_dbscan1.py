...
pickups_unvisited_index = [i for i in range(len(pickups_lonlat_list))]
pickups_cluster_list = []
e = 0.3 #the radius patameter, km
...
result_filename = 'dbscan' + '_' + pickup_time + '_' + str(e) + '_' + str(minpts) + '_random.txt'
result_filename_noise = 'dbscan' + '_' + pickup_time + '_' + str(e) + '_' + str(minpts) + '_noise' + '_random.txt'
