    ...
    def open_db(self):
        ...
        try:
            self.conn = pg.connect(
                    ...
                    user = 'postgres',
                    password = 'zq600991')
            self.cursor = self.conn.cursor(cursor_factory = pgextras.DictCursor)#The dict cursors allow to access to the retrieved records using an interface similar to the Python dictionaries instead of the tuples.
            return True
